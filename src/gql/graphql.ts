...
export type RootMutationType = {
  ...
  /** Refund an item at a lower price to a user */
...
export type ItemsByUserIdQueryVariables = Exact<{ [key: string]: never; }>;
